...
const server = http.createServer((req, res) => {
  ...
  // /api/create now flows through the Astro handler so the auth middleware can
  // gate it and the route can read the signed session. (checkOrigin is disabled
  // in astro.config.mjs, so the old 403-bypass intercept is no longer needed.)
